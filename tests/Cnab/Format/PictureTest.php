...
class PictureTest extends \PHPUnit_Framework_TestCase
{
    public function testDecode()
    {
        ...
        $this->assertEquals('900000000048957', Picture::decode('900000000048957', '9(15)', []));
    ...
    public function testEncode()
    {
        ...
        $this->assertEquals('07045', Picture::encode(70.45111111111111, '9(3)V9(2)', []));
        $this->assertEquals('070451', Picture::encode(70.45111111111111, '9(3)V9(3)', []));
        ...
        // big integer number
        $this->assertEquals('900000000048957', Picture::encode('900000000048957', '9(15)', []));
        ...
        $this->assertEquals('01022003', Picture::encode($data, '9(8)', ['date_format' => '%d%m%Y']));

        $data = new \DateTime('2009-08-07 01:02:03');
        $this->assertEquals('010203', Picture::encode($data, '9(8)', ['date_format' => '%H%M%S']));
        $this->assertEquals('030201', Picture::encode($data, '9(8)', ['date_format' => '%S%M%H']));
    }
}
